...
namespace IIS.Finalnyjj
{
    ...
    [View("СогласиеНаОпдE", new string[] {
            ...
            "Сотрудники.НомерПас as \'Номер паспорта\'"}, Hidden=new string[] {
            "Сотрудники.Фамилия"})]
    ...
    public class СогласиеНаОпд : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СогласиеНаОпдE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СогласиеНаОпдE", typeof(IIS.Finalnyjj.СогласиеНаОпд));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СогласиеНаОпдL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СогласиеНаОпдL", typeof(IIS.Finalnyjj.СогласиеНаОпд));
                }
            }
        }
    }
